            ...
            <div className="row d-flex justify-content-center">
                <div className="col-12 col-lg-9 mt-5 booking-details">
                    ...
                    <tbody>
                        ...
                        <td>{ new Date(booking?.checkInDate).toLocaleString('es-US') }</td>
                        </tr>
                        <tr>
                        <th scope="row">Check Out:</th>
                        <td>{ new Date(booking?.checkOutDate).toLocaleString('es-US') }</td>
                        </tr>
                        <tr>
                    ...
                    <tbody>
                        ...
                        <td>
                            <b className={ isPaid ? "greenColor" : "redColor" } > { isPaid ? 'Paid' : 'Not paid' }</b>
                        </td>
                        </tr>
                    </tbody>
                    </table>
